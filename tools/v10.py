...
from ..utils.similarity import TASK_ALIASES, TASKS
...
def get_molecular_properties(smiles: str) -> str:
    ...
    """
    from ..utils.adme import assess_adme_properties
    from ..utils.functional_groups import analyze_functional_groups
    from ..utils.metabolism import predict_metabolites
    from ..utils.molecule_profile import get_molecule_profile
    from ..utils.ring_systems import analyze_ring_systems
    from ..utils.safety import screen_safety
    from ..utils.three_d import get_3d_properties
...
def _compute_local_knn_metrics(
    ...
    from ..utils.similarity import _weighted_tanimoto
